"""
无标签数据集处理流程
将DICOM文件转换为nii.gz文件，用于后续的nnUNet分割
"""

print("="*70)
print("无标签数据集 → DICOM转换流程")
print("="*70)
...
def process_patient_dataset_no_labels(input_root, excel_path, output_images_dir):
    """
    处理无标签数据集
...
# 运行处理函数
process_patient_dataset_no_labels(INPUT_ROOT, EXCEL_PATH, OUTPUT_IMAGES_DIR)

print("\n" + "="*70)
print("✓ 所有步骤完成!")
print("="*70)
print(f"\n转换后的图像已保存到: {OUTPUT_IMAGES_DIR}")
print("\n接下来可以将这些图像用于nnUNet模型进行分割")
